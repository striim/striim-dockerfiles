...
docker tag  $AZURECR_ENDPOINT/striim/striim-mdr:latest $AZURECR_ENDPOINT/striim/striim-mdr:${STRIIM_RPM_TAG}
docker push $AZURECR_ENDPOINT/striim/striim-mdr:${STRIIM_RPM_TAG}
docker rmi striim-mdr
docker rmi $AZURECR_ENDPOINT/striim/striim-mdr:latest
docker rmi $AZURECR_ENDPOINT/striim/striim-mdr:${STRIIM_RPM_TAG}
...
docker tag $AZURECR_ENDPOINT/striim/striim-node:latest $AZURECR_ENDPOINT/striim/striim-node:${STRIIM_RPM_TAG}
docker push $AZURECR_ENDPOINT/striim/striim-node:${STRIIM_RPM_TAG}
docker rmi striim-node
docker rmi $AZURECR_ENDPOINT/striim/striim-node:latest
docker rmi $AZURECR_ENDPOINT/striim/striim-node:${STRIIM_RPM_TAG}
