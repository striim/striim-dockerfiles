...
docker tag striim-mdr:latest $ECR_ENDPOINT/striim-mdr:${STRIIM_DEB_TAG}
docker push $ECR_ENDPOINT/striim-mdr:${STRIIM_DEB_TAG}
...
docker tag striim-node:latest $ECR_ENDPOINT/striim-node:${STRIIM_DEB_TAG}
docker push $ECR_ENDPOINT/striim-node:${STRIIM_DEB_TAG}
